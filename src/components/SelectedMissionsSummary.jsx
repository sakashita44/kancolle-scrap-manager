                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isBase ? 'bg-amber-50 border-2 border-amber-300' : 'bg-white border border-blue-300'
                    )}
                  >
                    {/* ヘッダー: 任務名と選択解除ボタン */}
                      ...
                      <div className="flex items-center gap-1 ml-auto">
                        <button
                          ...
                          className={cn(
                            ...
                            isBase ? 'bg-amber-100 hover:bg-amber-200' : 'bg-slate-100 hover:bg-slate-200'
                          )}
                          title="回数を減らす"
                        >
                          <Minus className={cn('w-3 h-3', isBase ? 'text-amber-700' : 'text-slate-600')} />
                        </button>
                        <input
                          type="number"
                          min="1"
                          ...
                          className={cn(
                            ...
                            isBase ? 'border-amber-300 focus:ring-amber-400' : 'border-slate-200 focus:ring-blue-400'
                          )}
                        />
                        <button
                          onClick={() => isBase
                          ...
                          title="回数を増やす"
                        >
                          <Plus className={cn('w-3 h-3', isBase ? 'text-amber-700' : 'text-slate-600')} />
                        </button>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isBase ? 'bg-amber-500 hover:bg-amber-600 text-white' : 'bg-slate-100 hover:bg-slate-200 text-slate-700'
                      )}
                    >

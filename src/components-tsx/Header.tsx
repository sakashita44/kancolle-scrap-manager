...
export default function Header({
    ...
    const handleGitHubClick = () => {
        window.open(
            'https://github.com/sakashita44/kancolle-scrap-manager',
            '_blank',
            'noopener,noreferrer',
        );
    };
                    ...
                    {isMenuOpen && (
                        ...
                        >
                            <div className="py-1">
                                ...
                                <button
                                    onClick={() =>
                                        handleMenuItemClick(onDataReset)
                                    }
                            ...
                            <div className="py-1">
                                <button
                                    onClick={() =>
                                        handleMenuItemClick(onAboutOpen)
                                    }
                                    className="w-full px-4 py-2 text-left text-sm text-slate-700 hover:bg-slate-50 flex items-center gap-2"
                                >
                            ...
                            <div className="py-1">
                                <button
                                    onClick={() =>
                                        handleMenuItemClick(handleGitHubClick)
                                    }
                                    className="w-full px-4 py-2 text-left text-sm text-slate-700 hover:bg-slate-50 flex items-center gap-2"
                                >
